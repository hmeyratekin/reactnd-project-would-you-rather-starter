          ...
          <Segment inverted>
            <Form inverted>
              ...
              <Form.Group widths='equal'>
                ...
                <Form.Input fluid label='Option One' placeholder='Option One' onChange={this.onOptionOneChange}/>
                <Form.Input fluid label='Option Two' placeholder='Option Two'  onChange={this.onOptionTwoChange}/>
              </Form.Group>
              <Button type='submit' onClick={this.onNewQuestionSubmit}  disabled={this.state.optionOneText === "" || this.state.optionTwoText === ""
              }>Save</Button>
            </Form>
          </Segment>
        </div>
